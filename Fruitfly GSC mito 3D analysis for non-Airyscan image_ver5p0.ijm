 ...
 *                  - 4. Tophat was applied to get local signal.
 * 2025/4/10 rename "Fruitfly GSC mito 3D analysis for non-Airyscan image_ver5p0"
 * 2025/4/10 original name "20240502_Skeleton analysis for non Airyscan image_v5.ijm"
*/
// Preparation
	gs=2;
	ts=getTime();
